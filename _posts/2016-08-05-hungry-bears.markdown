...
This is the [harmonic series](https://en.wikipedia.org/wiki/Harmonic_series_(mathematics)) minus 1! In 2 hours, we expect the bear to eat <span class="inline-equation" data-expr="\frac{5}{6}"></span> kilograms. In 3 hours, we expect the bear to eat <span class="inline-equation" data-expr="\frac{13}{12}"></span> kilograms.  Interestingly, the harmonic series is divergent; the 